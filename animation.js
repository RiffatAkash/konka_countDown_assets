...
const displayIftarText = document.querySelector('.patch_note');
...
function checkIftarTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        displayTitle.style.backgroundImage = "url('assets/iftar/iftar.png')";
        displayIftarText.innerHTML = "<img src='assets/iftar/iftartext.png' alt=''>";
...
function checkSehriTime(todayDate, curTime) {
    ...
    if (diffTime<setTime && diffTime>=0){
        ...
        displayIftarText.innerHTML = "<img src='assets/iftar/sehritext.png' alt=''>";
        displayCounter.innerHTML = printTimer(diffTime);
    }
    else {
